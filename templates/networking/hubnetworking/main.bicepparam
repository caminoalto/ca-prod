...
param parHubNetworkingResourceGroupNamePrefix = 'rg-ca-conn'
param parDnsResourceGroupNamePrefix = 'rg-ca-dns'
param parDnsPrivateResolverResourceGroupNamePrefix = 'rg-ca-dnspr'
